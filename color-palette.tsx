...
const originalColorScales: ColorScales = {
  ...
  orange: {
    ...
    20: chroma.mix(carbon.orange[20], carbon.red[20], 0.15).hex(),
  ...
  blue: {
    10: chroma.mix(carbon.cyan[10], carbon.teal[10], 0.15).hex(),
    20: chroma.mix(carbon.cyan[20], carbon.teal[20], 0.15).hex(),
    30: chroma.mix(carbon.cyan[30], carbon.teal[30], 0.15).hex(),
    40: chroma.mix(carbon.cyan[40], carbon.teal[40], 0.15).hex(),
    50: chroma.mix(carbon.cyan[50], carbon.teal[50], 0.15).hex(),
    60: chroma.mix(carbon.cyan[60], carbon.teal[60], 0.15).hex(),
